...
const greetUser = (name) => {return "Welcome back"+ " " + name;}
...
function canWeDeliver()
    ...
    else if (n === '85205','85204','85203','85213','85206')
    {console.log('Sorry, we can not deliver to that address');
    }
    
    else {console.log('canWeDeliver');}
/* 
    Problem 2 Continued
...
{console.log(canWeDeliverTwo.includes(85204));}
{console.log(canWeDeliverTwo.includes(85203));}
{console.log(canWeDeliverTwo.includes(85213));}
{console.log(canWeDeliverTwo.includes(85206));}
...
const deals = [{ title:'15% Off!', desc: 'Applied to your entire order when you spend $30 or more'},{title:'Free Kids Meal with 2 Regular Entrees', desc: 'This deal lasts until the end of March!'}]
{console.log(deals);}

var percent = "15% Off!";
var percent2 = str.replace('10% Off!');
{console.log('deals');}
/*
